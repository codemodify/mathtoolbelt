...
namespace MathToolBelt.Sorting.Ui.App.ZedGraph
{
	...
	#region ContextMenu
		...
		private void contextMenuStrip1_Opening( object sender, CancelEventArgs e )
		{
			...
			if ( _masterPane != null && menuStrip != null )
			{
				...
				if ( _isShowContextMenu )
				{
					...
					item.Name = "copy";
					item.Tag = "copy";
					item.Text = Properties.Resources.Zedgraph_copy;
					...
					item.Name = "save_as";
					item.Tag = "save_as";
					item.Text = Properties.Resources.Zedgraph_save_as;
					...
					item.Tag = "page_setup";
					item.Text = Properties.Resources.Zedgraph_page_setup;
					...
					item.Name = "print";
					item.Tag = "print";
					item.Text = Properties.Resources.Zedgraph_print;
					...
					item.Name = "show_val";
					item.Tag = "show_val";
					item.Text = Properties.Resources.Zedgraph_show_val;
					...
					if ( pane == null || pane.ZoomStack.IsEmpty )
						menuStr = Properties.Resources.Zedgraph_unzoom;
					else
					{
						switch ( pane.ZoomStack.Top.Type )
						{
							...
							case ZoomState.StateType.Pan:
								menuStr = Properties.Resources.Zedgraph_unpan;
								break;
							case ZoomState.StateType.Scroll:
                                menuStr = Properties.Resources.Zedgraph_unscroll;
								break;
						}
					}
					...
					item.Name = "undo_all";
					item.Tag = "undo_all";
					menuStr = Properties.Resources.Zedgraph_undo_all;
					item.Text = menuStr;
                    ...
                    menuStr = Properties.Resources.Zedgraph_set_default;
					item.Text = menuStr;
		...
		public void Copy( bool isShowMessage )
		{
			if ( _masterPane != null )
			{
				...
				if ( isShowMessage )
				{
					string str = Properties.Resources.Zedgraph_copied_to_clip;
